      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div
            ...
            className="inline-block mb-4 px-6 py-3 bg-primary/20 backdrop-blur-sm rounded-full border border-primary/30"
          >
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="#contact"
              className="inline-flex items-center px-8 py-4 bg-primary text-white font-semibold rounded-xl hover:bg-primary-dark transition-all duration-300 shadow-lg shadow-primary/30 group"
            >
              Agendar Agora
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="#services"
              className="inline-flex items-center px-8 py-4 bg-white/10 backdrop-blur-sm text-white font-semibold rounded-xl hover:bg-white/20 transition-all duration-300 border border-white/20 group"
            >
              Nossos Serviços
              <ChevronRight className="ml-2 w-5 h-5 transform group-hover:translate-x-1 transition-transform" />
            </motion.a>
          ...
          >
            <motion.div
              whileHover={{ y: -5 }}
              className="flex items-center space-x-3 bg-white/5 backdrop-blur-sm rounded-xl p-4"
            >
              <Users className="w-8 h-8 text-primary" />
              <div>
                <p className="text-2xl font-bold text-white">1000+</p>
                <p className="text-secondary text-sm">Clientes Felizes</p>
              </div>
            </motion.div>
            <motion.div
              whileHover={{ y: -5 }}
            ...
            >
              ...
              <div>
                ...
                <p className="text-secondary text-sm">Avaliação Média</p>
              </div>
            </motion.div>
            <motion.div
              whileHover={{ y: -5 }}
            ...
            >
              ...
              <div>
                ...
                <p className="text-secondary text-sm">Anos de Experiência</p>
              </div>
            </motion.div>
            <motion.div
              whileHover={{ y: -5 }}
            ...
            >
              ...
              <div>
                ...
                <p className="text-secondary text-sm">Garantia</p>
              </div>
            </motion.div>
          </motion.div>
        </motion.div>
