        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <span className="text-xl font-bold animate-shimmer bg-gradient-to-r from-primary via-yellow-500 to-primary bg-[length:200%_100%] bg-clip-text text-transparent transition-all duration-500 hover:scale-110">
                NCAR
              </span>
            </div>
      ...
      <footer className="bg-dark text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-secondary">
                Seu carro em boas mãos desde 1995.
              </p>
            </div>
            <div>
          ...
          <div className="mt-8 pt-8 border-t border-dark-light text-center text-secondary">
            <p>
              &copy; {new Date().getFullYear()} NCAR. Todos os direitos
              reservados.
            </p>
          </div>
        </div>
